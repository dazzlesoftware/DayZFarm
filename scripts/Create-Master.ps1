...
.EXAMPLE
    .\Create-Master.ps1 -CpuCount 4 -MemoryGB 6 -VirtualSwitchName DayZFarmSwitch -IsoPath D:\Windows.iso
#>
[CmdletBinding()]
param(
...
Write-FarmLog "  5. Install DayZ Farm Agent (build output from src/DayZFarm.Agent)." -LogDirectory $logDirectory
