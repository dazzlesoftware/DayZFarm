...
public sealed class ManualGpuVirtualizationProvider : IGpuVirtualizationProvider
{
    ...
    public Task ConfigureAsync(string vmName, CancellationToken ct = default)
    {
        ...
        // scripts/Tools/Enable-GpuPartitionForVMs.ps1 — for hosts with an NVIDIA GPU; it isn't
        ...
        throw new NotSupportedException(
            ...
            "For an NVIDIA host, scripts/Tools/Enable-GpuPartitionForVMs.ps1 automates assignment + driver copy instead.");
    }
