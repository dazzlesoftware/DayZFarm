...
namespace DayZFarm.Agent.Security;
...
public sealed class AgentTokenStore
{
    ...
    {
        _logger = logger;
        var dir = tokenDirectory ?? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), "DayZFarmAgent");
