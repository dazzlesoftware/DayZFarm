...
/// <summary>
/// Best-effort <see cref="IGameStatusProvider"/> based on tailing DayZ's own RPT/script log
...
/// touching any caller.
/// </summary>
public sealed class DayZGameStatusProvider : IGameStatusProvider
{
    private readonly string _profileDirectory;
    private readonly DayZGameLauncher _launcher;
    private readonly ILogger<DayZGameStatusProvider> _logger;
    ...
    public DayZGameStatusProvider(string profileDirectory, DayZGameLauncher launcher, ILogger<DayZGameStatusProvider> logger)
    {
    ...
    public Task<ConnectionStatus> DetectConnectionStatusAsync(CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            if (latestLog is null)
                return Task.FromResult(ConnectionStatus.StartingGame);
