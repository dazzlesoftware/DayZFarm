...
public sealed class DayZClientInstance
{
...
/// <summary>Validates a <see cref="DayZClientInstance"/> beyond attribute validation (cross-field rules).</summary>
public static class DayZClientInstanceValidator
{
    public static IReadOnlyList<string> Validate(DayZClientInstance instance)
    {
